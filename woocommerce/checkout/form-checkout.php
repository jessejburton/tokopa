...
<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
      ...
      /*
        CODE ADDED BY BURTON MEDIA
        This will make the billing address required if their is a book in the cart
      */

      // Remove address unless needed.
      if(!function_exists('remove_wc_checkout_fields')){
        add_filter( 'woocommerce_checkout_fields' , 'remove_wc_checkout_fields' );
        function remove_wc_checkout_fields( $fields ) {
          ...
          return $fields;
			...
			foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
              ...
              $fields['billing']['billing_address_2']['label'] = "Address Line 2";
				...
				/* 	END CODE ADDED BY BURTON MEDIA */
